import { BinarySearchTreeV2 } from '../BinarySearchTree';
...
export const binarySearchTreeTests = (
  ...
  describe('getMinimum()', () => {
    ...
    test('non-empty tree', () => {
      const tree = new BinarySearchTreeV2(10);
      tree.insert(5);
      tree.insert(15);
      tree.insert(2);
  ...
  describe('delete()', () => {
    test('delete node from single-node BST', () => {
      const tree = new BinarySearchTreeV2(20);
      tree.delete(20);
    ...
    test('deletes value from the BST', () => {
      const tree = new BinarySearchTreeV2(50);
      tree.insert(20);
      tree.insert(10);
      tree.insert(5);
      tree.insert(15);
