...
class Trie {
   ...
   * The strings new count will be returned
   * 0 is returned if the modifications was unsuccessful.
   * @param {string} str
   ...
   * The strings new count will be returned.
   * O is returned if the insertion was unsuccessful
   * @param {string} str
   * @param {number} count
   * @returns {number}
   */
   ...
   * @param {string} str
   * @returns {boolean} The number of times a string appears in the Trie.
   */
   ...
   * @param {string} str
   * @returns {boolean} Whether the string is in the Trie.
   */
   ...
   * that start with the given prefix.
   * @param {string} prefix
   * @returns {number} The total number of strings in the Trie that start with the prefix.
   */
  ...
  /**
   * Counts the different number of strings in th Trie.
   * that start with the given prefix.
   * @param {string} prefix
   * @returns {number} The different number of strings in the Trie that start with the prefix.
   */
