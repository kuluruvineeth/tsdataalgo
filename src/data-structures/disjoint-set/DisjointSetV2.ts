class DisjointSetV2 {
   ...
   * @returns The total number of elements in the elements set.
   */
   ...
   * @returns {number} The number of disjoint sets.
   */
  get size(): number {
    return this._size;
  }
   ...
   * @returns {number} The root of the set that the element belongs to.
   */
   ...
   * @returns {boolean} Whether the two elements belongs to the same set.
   */
